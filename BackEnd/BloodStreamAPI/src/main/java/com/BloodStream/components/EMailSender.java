...
public class EMailSender {
  ...
  @Value("${com.BloodStream.MAIL_LINK}")
  ...
  public void sendVerificationEmail(String to, String token) throws MessagingException {
    ...
    template.setSubject("BloodStream Account Verification");
    // bulding message for mail 
    StringBuilder message = new StringBuilder("<h1>BloodStream account verification.</h1>");
...
public void resetPasswordEmail(String email,int otp) throws MessagingException {
	...
	String url = origin+"/resetPassword/";
	 MimeMessage helper = emailSender.createMimeMessage();
	    ...
	    template.setSubject("BloodStream Account Password Reset Mail");
	    StringBuilder message = new StringBuilder("<h1>BloodStream account verification.</h1>");
